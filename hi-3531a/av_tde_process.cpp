...
void *av_tde_process_thread(void * arg)
{
	...
	while (1)
	{
		while( (s32Ret=HI_MPI_VPSS_GetChnFrame(HI_SUCCESS != p_compoun_cfg->m_vpss_cfg.m_group_number, VPSS_CHN_TYPE_RENDER, &pstVideoFrame, 5)) && (TDE_EXIT_CMD_START == g_tde_ctx.m_exit_cmd) )
		{
